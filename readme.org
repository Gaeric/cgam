...
** physics
   ...
   目前对于我而言，软体物理模拟可能是一个非常重要的功能。我需要掌握更多的物理模拟的知识，尤其是PBD和XPBD方法。因此，需要完成对Ten Minute Physics的学习。

   当前计划按章节划分，理解每一章内容的原理和实现。
* TODO todolist 
*** wgpu_rtr
**** rt_shadow
**** rt_gi
...
* Tips
  ...
  2. 关于lambertian漫反射的问题
     在球面上均匀采样并投影到半球上，可以获得符合lambertian反射的分布，参考issue如下：

     https://github.com/RayTracing/raytracing.github.io/discussions/1380
