...
class Ball {
  ...
  simulate() {
    ...
    this.vel.addScaleVector(gPhysicsScene.gravity, gPhysicsScene.dt);
    this.pos.addScaleVector(this.vel, gPhysicsScene);
...
function initThreeScene() {
  ...
  var ground = new THREE.Mesh(
    ...
    new THREE.MeshPhongMaterial({ color: 0xa0adaf, shiniess: 150 }),
  );
  ...
  start(x, y) {
    ...
    if (intersects.length > 0) {
      ...
      if (obj) {
        ...
        pos.addScaleVector(this.raycaster.ray.direction, this.distance);
